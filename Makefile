...
all-yaml: kubeless.yaml kubeless-rbac.yaml kubeless-openshift.yaml kafka-zookeeper.yaml kafka-zookeeper-rbac.yaml
...
kafka-zookeeper-rbac.yaml: kafka-zookeeper-rbac.jsonnet kafka-zookeeper.jsonnet
